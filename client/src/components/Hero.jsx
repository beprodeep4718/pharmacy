...
<div className="text-white max-w-lg">
  <p className="text-[42px]/14 font-bold monda  spacing-loose ">Optimize Your Health  <span className='whitespace-nowrap'>Care: Seamless Medication</span>  Ordering, Management, 
and Reminders in 
One Place!</p>
  <p className="text-lg mb-6 pt-6 maven-pro">[website name] provides seamless medication ordering, comprehensive prescription management, and timely reminders—all in one secure, user-friendly platform.</p>
